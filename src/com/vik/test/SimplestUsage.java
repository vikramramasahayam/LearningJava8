...
public class SimplestUsage {
    ...
    /**
     * The Dog class doesn't have its own implementation of the {@link #eat} method and uses the default implementation.
     */
    public static class Dog implements Animal {}

    /**
     * The Mosquito class implements {@link #eat} method, its own implementation overrides the default implementation.
     *
     */
